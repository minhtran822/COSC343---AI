...
class visualiser:
   ...
   def __init__(self, speed, gridSize, resolution=(720,480), playerStrings=None):
      ...
      self.im_creatures = [pygame.image.load('cosc343game/images/creature_blue.png'),
                      pygame.image.load('cosc343game/images/creature_red.png')
                      ]

      self.im_food = pygame.image.load('cosc343game/images/strawberry-green.png')
      ...
      self.font = pygame.font.Font("cosc343game/arial.ttf", 14)
      self.reset()
